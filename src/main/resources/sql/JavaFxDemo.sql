...
CREATE TABLE javafxdemo.tblcustomer (
  customerid INT NOT NULL AUTO_INCREMENT,
  customerfirstname VARCHAR(45) NOT NULL,
  customerlastname VARCHAR(45) NOT NULL,
  customerstreetaddress1 VARCHAR(45) NOT NULL,
  customercity VARCHAR(45) NOT NULL,
  customercountry VARCHAR(45) NOT NULL,
  customermobilephone VARCHAR(45) NOT NULL,
  customeremail VARCHAR(45) NOT NULL,
  customertype VARCHAR(45) NOT NULL,
  customeractive TINYINT NOT NULL,
  PRIMARY KEY (customerid),
  UNIQUE INDEX customerkey_UNIQUE (customerid ASC) VISIBLE);
  
  /*-------------------------------------------------------------------------------------*/
  
  INSERT INTO javafxdemo.tblcustomer
(customerid, customerfirstname, customerlastname, customerstreetaddress1,
 customercity, customercountry, customermobilephone, customeremail, customertype, customeractive)
VALUES
(null, "Aaron", "Kalloo", "#7 Valley View Drive Pinto Road", "Arima", "Trinidad",
 "(868)723-0141", "aaronkalloo@gmail.com", "Corporate", 1);