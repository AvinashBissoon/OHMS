...
public class LandscapingController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        cBoxService.setItems(FXCollections.observableArrayList("Landscaping: Lawn Maintenance", "Landscaping: Tree Trimming", "Landscaping: Tree Removal", "Landscaping: Plant Care"));
