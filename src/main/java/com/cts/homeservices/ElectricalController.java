/** This class provides control and allows for customers to place a booking for any Electrical Service provided.
...
public class ElectricalController implements Initializable {
    ...
    //Class Parameters that connect electrical-view.fxml to this controller
    @FXML
    ...
    //Allows Customer to place electrical booking and save it to the database
    @FXML
