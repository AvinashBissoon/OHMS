...
public class PlumbingController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        cBoxService.setItems(FXCollections.observableArrayList("Plumbing: Pipeline Installation", "Plumbing: Pipeline Repair", "Plumbing: Wastewater Management", "Plumbing: Faucet Replacement"));
